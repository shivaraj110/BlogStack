...
function Blogs(data: BlogData) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-row border-b-[1px] pb-5">
        <div className="w-fit p-1 flex flex-row mt-10  md:ml-28 ml-12 transi poppins-extralight">
          {data.tags[0] !== "notags"
            ? data.tags.map((t) => (
                <div className="rounded-3xl w-fit p-1 px-2 flex justify-start h-fit ml-4 transi bg-gray-200 text-gray-800 poppins-extralight">
                  {t}
                </div>
              ))
            : null}
      ...
      {/* <div className="h-[0.5px] mt-10  md:ml-32 ml-12 md:mr-32 transi mr-12 mb-1 bg-gray-300"></div> */}
    </div>
  );
}
