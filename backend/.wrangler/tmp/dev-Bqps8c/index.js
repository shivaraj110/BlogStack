...
// .wrangler/tmp/bundle-KZZvhC/checked-fetch.js
...
// ../../../AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/runtime/node/timers/$cloudflare.mjs
...
// ../../../AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/runtime/web/performance/index.mjs
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config2 = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\hp\\Documents\\medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\hp\\Documents\\medium\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null
      },
...
// node_modules/@shivaraj0110/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@shivaraj0110/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_process();
...
// .wrangler/tmp/bundle-KZZvhC/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
// .wrangler/tmp/bundle-KZZvhC/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
var verifyUser = /* @__PURE__ */ __name(async (c, next) => {
  const header = c.req.header("authorization") || "";
  const token = header.split(" ")[1];
  const value = await verify2(token, c.env.JWT_SECRET);
  if (value.id) {
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    ...
    if (success) {
      ...
      const token = await sign2({ id: response.id }, c.env.JWT_SECRET);
      return c.json({
        jwt: token
      });
    } else {
...
userRouter.post("/signin", async (c) => {
  ...
  try {
    ...
    if (success) {
      ...
      const jwt5 = await sign2({ id: user.id }, c.env.JWT_SECRET);
      return c.json({
        jwt: jwt5
      });
    } else {
...
userRouter.post("/bookmark", verifyUser, async (c) => {
  ...
  try {
    const { success } = import_medium_common.createBlogPost.safeParse(body);
    if (!success) {
      c.status(413);
      c.json({
        msg: "invalid inputs!"
...
var getBookmarkId = /* @__PURE__ */ __name(async (c, next) => {
  const prisma = new import_edge.PrismaClient({
    datasourceUrl: c.env.DATABASE_URL
  }).$extends(withAccelerate());
  const body = await c.req.json();
...
blogRouter.post("/", async (c) => {
  ...
  const date = (/* @__PURE__ */ new Date()).getDate().toString();
  ...
  try {
    const { success } = import_medium_common2.createBlogPost.safeParse(body);
    if (success) {
...
blogRouter.put("/", async (c) => {
  ...
  try {
    const { success } = import_medium_common2.updateBlogPost.safeParse(body);
    if (success) {
