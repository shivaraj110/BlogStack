...
function Landing() {
  ...
  return (
    <div>
      ...
      <SignedIn>
        <div className="p-5 mx-auto size-fit space-x-2 flex justify-center bg-gradient-to-r from-cyan-300 to-purple-300 py-10 rounded-xl mt-24">
          <div>Welcome back! {user?.username},</div>
          <div className="space-x-2 pt-5 ">
            <Link
              to={"/dashboard"}
              className="p-2 backdrop-blur-sm bg-white/45 text-gray-700 font-medium rounded-lg border mt-5">
              proceed to dashboard
            </Link>
            <button className="p-2 backdrop-blur-sm bg-white/45 text-gray-700 font-medium rounded-lg border mt-5">
              <SignOutButton />
            </button>
          </div>
        </div>
