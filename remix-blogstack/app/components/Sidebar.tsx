  ...
  return (
    <div className={`  ${fold ? "w-[75px] " : "w-[215px] "}  transi text-sm `}>
      <div
        className={` ${
          fold ? "hidden" : "flex"
        } pt-6 pr-3 text-gray-600 font-light cursor-pointer justify-end`}
        onClick={() => {
          setFold(true);
        }}>
        <X />
      ...
      <div
        className={` ${
          fold ? "flex" : "hidden"
        } justify-center cursor-pointer  pt-6 gap-[2px] mx-auto flex-row`}
        onClick={() => {
          setFold(false);
        }}>
      ...
      <Link to={"/dashboard/blogs"}>
        <div
          className={`text-gray-600 flex cursor-pointer py-[10px] mt-12 ${
            fold ? "justify-center" : " pl-6 justify-start"
          } ${
            currRoute == "feed" ? "bg-white/35" : null
          } hover:bg-white/35 mx-3 rounded-lg `}
          onClick={() => {
            setFold(true);
          }}>
          <svg
          ...
          <div
            className={` ${
              fold ? "hidden" : "flex"
            } translate-y-[2px] font-semibold pl-3`}>
            Feed
          </div>
        </div>{" "}
      </Link>
      ...
      <div className=" hover:bg-white/25 rounded-lg mx-3 "></div>
      <div
        onClick={() => {
          setFold(true);
          const params = new URLSearchParams();
      ...
      <div
        className={` ${
          fold ? "flex " : "hidden"
        } mx-auto mt-4 bg-slate-500 h-[1px] w-[25px]`}></div>
    </div>
  );
}
