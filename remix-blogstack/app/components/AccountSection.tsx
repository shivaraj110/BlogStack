      ...
      <div className="flex items-center justify-between p-6 border-b">
        ...
        <div className="flex gap-2">
          <div className="relative">
            ...
            <input
              placeholder="Search"
              className="pl-8 h-9 w-full rounded-md border border-gray-300 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-orange-500"
            />
          </div>
        </div>
      </div>
